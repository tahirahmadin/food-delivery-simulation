...
export const GridMap: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Roads */}
      {/* Horizontal Road */}
      <div className="absolute left-20 right-20 top-1/2 -translate-y-1/2 h-8 bg-[#1C1C1C] shadow-lg z-5">
        {/* Road texture */}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="h-[3px] w-full"
               style={{
                backgroundImage: 'linear-gradient(90deg, rgb(255 255 255) 50%, transparent 50%)',
      ...
      {/* Vertical Road */}
      <div className="absolute top-20 bottom-20 left-1/2 -translate-x-1/2 w-8 bg-[#1C1C1C] shadow-lg z-5">
        {/* Road texture */}
        <div className="absolute inset-0 opacity-10 mix-blend-overlay"
             style={{
               backgroundImage: 'url("https://images.unsplash.com/photo-1585732832634-77c8a8683f67?q=80&w=500&auto=format")',
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-[3px] h-full"
               style={{
                backgroundImage: 'linear-gradient(0deg, rgb(255 255 255) 50%, transparent 50%)',
      ...
      {/* Intersection */}
      <div className="absolute left-1/2 top-1/2 w-8 h-8 -translate-x-1/2 -translate-y-1/2 bg-[#1C1C1C] rounded-full shadow-xl z-6">
